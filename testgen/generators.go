...
var EthMulticall = MethodTests{
	...
	[]Test{
		...
		{
			"multicall-overwrite-existing-contract",
		...
		{
			"multicall-overflow-nonce-validation",
		...
		{
			"multicall-try-to-move-non-precompile",
		...
		{
			"multicall-contract-calls-itself",
		...
		{
			"multicall-long-block-distances",
